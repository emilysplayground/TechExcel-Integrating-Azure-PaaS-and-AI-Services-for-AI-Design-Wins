...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get booking for hotel.")]
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get bookings by hotels and min date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel")] int hotelId, 
        [Description("Min date")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get bookings with muliple hotel rooms.")]
